...
<?php else : ?>
	<div class="woocommerce-notice woocommerce-notice--info woocommerce-info woocommerce-alert"><?php esc_html_e( 'New payment methods can only be added during checkout. Please contact us if you require assistance.', 'woocommerce' ); ?>
