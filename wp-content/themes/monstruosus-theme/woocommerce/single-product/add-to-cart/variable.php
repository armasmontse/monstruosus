		...
		<table class="variations" cellspacing="0">
			<tbody>
				...
				<?php foreach ( $attributes as $attribute_name => $options ) : ?>
					<tr>
						<td class="label"><label for="<?php echo sanitize_title( $attribute_name ); ?>"><?php echo __('Step', TRANSDOMAIN) . ' ' . $i . ': ' . __('Select your', TRANSDOMAIN) . ' ' . wc_attribute_label( $attribute_name ); ?></label></td>
						<td class="value">
							<?php
